    ...
    *,
    ...
    return {
        ...
        "inplay_summary": {
            ...
            "ppm_home_prior": inplay_dict.get("ppm_home_prior"),
            "ppm_away_prior": inplay_dict.get("ppm_away_prior"),
            "match_minutes": inplay_dict.get("match_minutes"),
            "n_simulations": inplay_dict.get("n_simulations"),
